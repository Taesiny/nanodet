...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, activation='ReLU'):
        ...
        self.bn1 = LayerNorm(inplanes, eps=1e-6, data_format="channels_first")
...
class ResNet_9(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn1 = LayerNorm(96, eps=1e-6, data_format="channels_first")
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                LayerNorm(planes, eps=1e-6, data_format="channels_first"),
            )
